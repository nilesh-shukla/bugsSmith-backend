...
const listProfiles = async (req, res) => {
  try {
    ...
    const data = rows.map((r) => ({
      ...
      inputQualityScore: r.inputQualityScore ?? null,
      modelConfidence: r.modelConfidence ?? null,
...
const getProfileDetail = async (req, res) => {
  try {
    ...
    const detail = {
      ...
      inputQualityScore: pr.inputQualityScore ?? null,
      modelConfidence: pr.modelConfidence ?? null,
